...
function Map({ highlightedStates = [] }: { highlightedStates: string[] }) {
  ...
  const fill = (stateId: string) => {
    return highlightedStates.includes(stateId) ? highlightFill : regularFill;
  };
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="959" height="593">
      ...
      <g style={borderStyles} fill="none">
        <path
          className="al-fl"
      ...
      <path
        style={{ stroke: "lightgray", strokeWidth: 4 }}
        fill="none"
